...
.ascii "->SIZE_slim_device_id $12 sizeof(struct slim_device_id)"	#
# 0 "" 2
...
.ascii "->SIZE_platform_device_id $28 sizeof(struct platform_device_id)"	#
# 0 "" 2
...
.ascii "->SIZE_x86_cpu_id $20 sizeof(struct x86_cpu_id)"	#
# 0 "" 2
...
# 0 "" 2
# scripts/mod/devicetable-offsets.c:277: 	DEVID(vchiq_device_id);
# 277 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_vchiq_device_id $32 sizeof(struct vchiq_device_id)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:278: 	DEVID_FIELD(vchiq_device_id, name);
# 278 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_vchiq_device_id_name $0 offsetof(struct vchiq_device_id, name)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:280: 	DEVID(coreboot_device_id);
# 280 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_coreboot_device_id $8 sizeof(struct coreboot_device_id)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:281: 	DEVID_FIELD(coreboot_device_id, tag);
# 281 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_coreboot_device_id_tag $0 offsetof(struct coreboot_device_id, tag)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:284: }
#NO_APP
	xorl	%eax, %eax	#
	ret	
	.size	main, .-main
